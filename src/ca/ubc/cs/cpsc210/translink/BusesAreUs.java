...
import ca.ubc.cs.cpsc210.translink.ui.BusRouteDrawer;
...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        if(nearest == null){
            this.myNearestStop = null;
            onResume();
        }else if(locn == null){
            this.myNearestStop = null;
            onResume();
        }else if(myNearestStop == null || myNearestStop.getLocn() != locn){
