...
public class HttpArrivalDataProvider extends AbstractHttpDataProvider {
    ...
    protected URL getURL() throws MalformedURLException {
        ...
        String urlAsString = "http://api.translink.ca/rttiapi/v1/stops/" + this.stop.getNumber() + "/estimates?apikey=" + TranslinkToken.TRANSLINK_API_KEY;
        URL returnurl = new URL(urlAsString);
        return returnurl;
    }
